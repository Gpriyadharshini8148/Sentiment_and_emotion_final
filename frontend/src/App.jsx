  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          setHistory(prev => [payload.new, ...prev].slice(0, 5));
        }
      )
      .subscribe();
            ...
            history.map((item) => (
              ...
              >
                ...
                <div className="history-badges">
                  <span
                    className="badge"
                    style={{ backgroundColor: `${getSentimentColor(item.sentiment)}22`, color: getSentimentColor(item.sentiment) }}
                  >
                    {item.sentiment}
                  </span>
                  <span
                    className="badge"
                    style={{ backgroundColor: `${getEmotionColor(item.emotion)}22`, color: getEmotionColor(item.emotion) }}
                  >
                    {item.emotion}
                  </span>
                </div>
