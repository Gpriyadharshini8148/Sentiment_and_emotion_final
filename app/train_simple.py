...
# Constants
DATASET_PATH = r"D:\proj\data\tanglish_2000_realistic_with_sentiment_emotion (1).csv"
MODELS_DIR = "../models1"
...
def train():
    ...
    # 2. Prepare Data
    X = df['clean_text']
    y_sentiment = df['sentiment'] # e.g. Positive, Negative
    ...
    # 5. Save Models
    print("Saving models to ../models1/...")
